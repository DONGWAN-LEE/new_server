...
import { DataSource, EntityManager, In, QueryRunner, Repository, MoreThanOrEqual, getConnection} from 'typeorm';
import { user_timer } from '../../entities/user/user_timer.entity';

@Injectable()
export class user3_timer_table {
    /*constructor(private readonly dataSource: DataSource) {
        
    }*/

    constructor(
        @InjectRepository(user_timer, 'user3DB')
